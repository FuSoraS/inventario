...
--
-- Table structure for table `codiMarca`
--
...
--
-- Dumping data for table `codiMarca`
--

LOCK TABLES `codiMarca` WRITE;
/*!40000 ALTER TABLE `codiMarca` DISABLE KEYS */;
/*!40000 ALTER TABLE `codiMarca` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `codiProducto`
--
...
--
-- Dumping data for table `codiProducto`
--

LOCK TABLES `codiProducto` WRITE;
/*!40000 ALTER TABLE `codiProducto` DISABLE KEYS */;
INSERT INTO `codiProducto` VALUES
(1,3,'Coca cola','3PRODUCTO_Coca cola'),
(2,4,'Fanta','4PRODUCTO_Fanta');
/*!40000 ALTER TABLE `codiProducto` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER triggerCodiMarca
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER triggerEliminarMarca
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER triggerCodiProdu
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER triggerEliminarProdu
...
-- Dump completed on 2024-06-03 18:05:05
